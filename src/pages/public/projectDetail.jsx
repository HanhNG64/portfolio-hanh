      ...
      <Card className="mt-14 shadow-lg">
        ...
        <CardBody>
          ...
          <div className="mb-3">
            ...
            {project.description && <Typography color="gray">{project.description}</Typography>}
          </div>
          ...
          <div className="mb-3">
            ...
            {project.problematic && <Typography color="gray">{project.problematic}</Typography>}
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div>
              <a href={project.site}>
                <Button disabled={!project.site} size="lg" className="flex items-center gap-2 hover:text-secondary">
                  Voir le site
