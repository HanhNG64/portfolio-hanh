  ...
  return (
    <section className="relative w-full pt-14 overflow-hidden gradient-border-top gradient-border-left md:mt-20">
      ...
      <div className="flex flex-col justify-center items-center md:flex-row md:justify-center md:items-center md:mb-10 mx-auto">
        <img className="h-[300px] object-contain" src={frontend} alt="logo de Frontend" />
        ...
        <img className="h-[300px] object-contain" src={backend} alt="logo de Backend" />
      </div>
      <div className="bg-tertiary pt-0.5 pb-10">
        <h2 className="relative z-0 text-1xl w-fit mx-auto mb-7 mt-10 sm:text-3xl sm:mb-10 md:text-4xl md:mb-12 after:absolute after:w-full after:h-2 after:bottom-0 after:left-0 after:-z-10 after:bg-main-light sm:after:h-5 sm:after:-bottom-2">
          Outils utilisés
        </h2>
