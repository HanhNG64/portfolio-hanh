...
const ABout = () => {
  return (
    <section className="px-8 w-full">
      ...
      <div
        id="about"
        className="relative flex flex-col max-w-screen-md ml-auto mt-14 overflow-hidden shadow-black gradient-border-top-primary gradient-border-left-primary md:pl-5 md:flex-row md:justify-center md:items-center"
      >
